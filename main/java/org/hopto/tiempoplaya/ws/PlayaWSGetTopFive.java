...
public class PlayaWSGetTopFive extends AsyncTask<String,Object,  List<TPlayas>> {
    ...
    String METHOD_NAME = "getTopFiveBeaches";
    String SOAP_ACTION = "http://ws.tiempoplaya.hopto.com/getTopFiveBeaches";
    ...
    private List<TPlayas> getListPlayas() {
        ...
        for (SoapObject o : result){
            ...
            playa.setDistance(-1);
            playa.setDataRating(Integer.valueOf(o.getProperty(12).toString()));
