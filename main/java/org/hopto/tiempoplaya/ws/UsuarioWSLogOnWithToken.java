...
public class UsuarioWSLogOnWithToken extends AsyncTask<String, Object, TUsuarios> {
    ...
    public UsuarioWSLogOnWithToken(ProgressBar progressBar) {
    ...
    protected TUsuarios doInBackground(String... strings) {
        ...
        request.addProperty("contrasenya", "");
        ...
        System.out.println("INFO TK ---> "+getAuthUser());
        return getAuthUser();
    }
