...
public class PlayaWSSearchByString extends AsyncTask<String, Object, List<TPlayas>> {
    ...
    String METHOD_NAME = "searchPlayaByWord";
    String SOAP_ACTION = "http://ws.tiempoplaya.hopto.com/searchPlayaByWord";
    ...
    protected List<TPlayas> doInBackground(String... param) {
        ...
        request.addProperty("stringToFind", param[5].toString());

        //DEBUG
        //Log.d("WS_SEARCH_PLAYA: ", request.toString() + " " + tk);
        ...
        Vector<SoapObject> responseVector = null;
        SoapObject responseObject = null;
        ...
        try {
            ...
            responseVector = (Vector<SoapObject>) envelope.getResponse();
            setListPlayas(responseVector.size(), responseVector);

        } catch (SoapFault soapFault) {
            //Log.d("Soap Fault Exception ", soapFault.toString());
            ...
            try {
                ...
                if (responseObject != null) {
                    setListPlayas(responseObject);
                }
            } catch (SoapFault e) {
                // TODO Auto-generated catch block
                //Log.d("Soap Fault Exception ", e.toString());
    ...
    private void setListPlayas(SoapObject response) {

        SoapObject o = response;
        //DEBUG
        //Log.d("DEBUG: ", o.toString());
